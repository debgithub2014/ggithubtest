...
;(function ($, window, document, undefined) {
	...
	var pluginName = "tooltipster",
		defaults = {
			...
			interactiveHoverClose: true, // added by R Jaya Chandra
			offsetX: 0,
			offsetY: 0,
			onlyOne: true,
			position: 'top',
				...
				$this.clearQueue().delay(object.options.delay).queue(function() {
					...
					object.options.functionBefore($this, function() {
						...
						// if the tooltip isn't already open, open that sucker up!
							...
							tooltipster.mouseleave(function() {
								// added by R Jaya Chandra , if interactive tooltip activated by a click, when you don't wanr to close the tooltip when you hover off the tooltip
								if( object.options.interactiveHoverClose ){
									object.hideTooltip();
								}
							});
						}
